    ...
    return (
        <section id="contact" className='relative'>
            <div className='container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap'>
                <div className='lg:mx-auto md:w-2/3 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative'>
                    <iframe
                        width="100%"
                        height="100%"
                        title="map"
                    ...
                    />
                    <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md lg:w-2/3 md:w-4/5">
